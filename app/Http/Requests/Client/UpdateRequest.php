...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'dni'=>'required|string|unique:clients,dni,'.$this->route('client')->id.'|max:16|min:8',
            'ruc'=>'required|string|unique:clients,ruc,'.$this->route('client')->id.'|max:16|min:8',
            'address'=>'required|string|max:255',
            'phone'=>'required|string|unique:clients,phone,'.$this->route('client')->id.'|max:16|min:8',
