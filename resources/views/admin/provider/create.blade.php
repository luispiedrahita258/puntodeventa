            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="ruc_number" id="ruc_number" aria-describedby="helpId" placeholder="Número de RUC" required>
                      </div>

                      <div class="form-group">
                        <label for="address">Dirección</label>
                        <input type="text" class="form-control" name="address" id="address" aria-describedby="helpId" placeholder="Dirección" required>
                      </div>
                      <div class="form-group">
                        <label for="phone">Número de Contacto</label>
                        <input type="number" class="form-control" name="phone" id="phone" aria-describedby="helpId" placeholder="Número de Celular" required>
                      </div>
